...
export default function DataAnalytics() {
  ...
  const analyticsServices = [
    ...
    },
    {
      ...
      description:
        "Interactive dashboards that provide instant insights into your business metrics.",
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <motion.div className="space-y-8" variants={staggerContainerVariants}>
                ...
                <motion.p
                  ...
                  variants={fadeUpVariants}
                >
                  Transform your data into actionable insights with advanced analytics and business
                  ...
                  {dataChallenges.map((challenge, index) => (
                    ...
                    >
                      <div className="flex items-center space-x-3 mb-3">
                        <div
                          className={`w-3 h-3 bg-gradient-to-r ${challenge.color} rounded-full`}
                        ></div>
                ...
                <motion.div className="space-y-6" variants={staggerContainerVariants}>
                  {analyticsApproach.map((approach, index) => (
                    <motion.div
                      ...
                      transition={{ duration: 0.3 }}
                    >
                      <div className="text-green-400 mt-1 flex-shrink-0">{approach.icon}</div>
                      <div>
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <motion.p
              ...
              variants={fadeUpVariants}
            >
              Let's unlock the hidden insights in your data and drive data-driven decision making
