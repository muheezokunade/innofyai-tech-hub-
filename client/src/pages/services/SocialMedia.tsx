...
const platforms = ["Instagram", "X (Twitter)", "LinkedIn", "Facebook", "TikTok", "YouTube"];
  ...
  return (
    <Layout>
      <Helmet>
        ...
        <meta
          name="description"
          content="Grow your brand with strategic social media marketing, content creation, analytics, and community management across all major platforms."
        />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            description:
              "Grow your brand with strategic social media marketing, content creation, analytics, and community management across all major platforms.",
          })}
        </script>
      </Helmet>
      <motion.section
        ...
        className="py-16 px-4 md:px-16 bg-gradient-to-br from-blue-900 to-purple-700 rounded-3xl shadow-xl"
      >
        <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">Social Media</h1>
        <p className="text-lg md:text-xl text-blue-100 mb-8 max-w-2xl">
          Grow your brand and engage your audience with our expert social media marketing, content
          creation, and analytics services across all major platforms.
        </p>
        <motion.div
          className="w-24 h-24 mb-8 bg-white/10 rounded-2xl flex items-center justify-center"
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-3">
              {platforms.map((platform, i) => (
                <motion.span
                  key={platform}
                  className="bg-blue-800 text-blue-100 px-4 py-2 rounded-lg shadow"
        ...
        >
          <Link href="/contact">
            <span className="inline-block px-8 py-4 bg-gradient-to-r from-blue-500 to-purple-600 text-white font-bold rounded-xl shadow-lg hover:scale-105 transition-transform cursor-pointer">
