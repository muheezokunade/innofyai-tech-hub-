...
export function Navigation() {
  ...
  const creativeServices = [
    ...
    },
    {
      ...
      description: "Brand identity systems",
      href: "/services/branding-merch",
      color: "from-yellow-600 to-orange-600",
    },
    {
      icon: BarChart3,
      title: "Social Media",
      description: "Strategic social growth",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center space-x-4">
            <motion.div variants={themeToggleVariants} whileHover="hover">
              <Button
                variant="ghost"
                size="icon"
            ...
            <Sheet open={isOpen} onOpenChange={setIsOpen}>
              ...
              <SheetContent
                side="right"
                className="w-[280px] sm:w-[400px] bg-white/10 backdrop-blur-md border-l border-white/20"
              >
