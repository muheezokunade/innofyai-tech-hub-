          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <Card className="text-center p-6 hover-lift">
              <CardContent className="pt-6">
                ...
                <h3 className="text-xl font-bold text-space text-foreground mb-4">Logo & Identity Design</h3>
                <p className="text-muted-foreground">Memorable logos and comprehensive visual identity systems.</p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center p-6 hover-lift">
              <CardContent className="pt-6">
                ...
                <h3 className="text-xl font-bold text-space text-foreground mb-4">Brand Guidelines & Assets</h3>
                <p className="text-muted-foreground">Comprehensive brand standards and asset libraries for consistency.</p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center p-6 hover-lift">
              <CardContent className="pt-6">
                ...
                <h3 className="text-xl font-bold text-space text-foreground mb-4">Custom Merchandise</h3>
                <p className="text-muted-foreground">High-quality branded merchandise that amplifies your brand presence.</p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center p-6 hover-lift">
              <CardContent className="pt-6">
                ...
                <h3 className="text-xl font-bold text-space text-foreground mb-4">Brand Strategy Consulting</h3>
                <p className="text-muted-foreground">Strategic guidance for brand positioning and market differentiation.</p>
              </CardContent>
            </Card>
          </div>
        </div>
            ...
            {[
              {
                step: "1",
                title: "Discovery",
                description: "Brand audit, market research, and competitor analysis to understand your landscape.",
                color: "bg-orange-500"
              },
              {
                step: "2", 
                title: "Strategy",
                description: "Define brand positioning, personality, values, and unique value proposition.",
                color: "bg-red-500"
              },
              {
                step: "3",
                title: "Design",
                description: "Create visual identity including logo, typography, colors, and style elements.",
                color: "bg-pink-500"
              },
              {
                step: "4",
              ...
              },
              {
                step: "5",
                title: "Evolution",
                description: "Monitor brand performance and evolve strategy based on market feedback.",
                color: "bg-indigo-500"
              }
            ].map((phase) => (
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              },
              {
                ...
                image: "https://images.unsplash.com/photo-1607734834512-5ab272b6f64d?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&h=300"
              }
            ].map((category) => (
              <Card key={category.category} className="overflow-hidden hover-lift">
                ...
                <CardContent className="p-6">
                  <h3 className="text-xl font-bold text-space text-foreground mb-3">{category.category}</h3>
      ...
      <section className="py-20 bg-muted/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16">
            <div>
              <h2 className="text-3xl font-bold text-space text-foreground mb-6">Brand Challenges</h2>
              <div className="space-y-6">
                <Card className="p-6 bg-red-50 dark:bg-red-950/20 border-red-200 dark:border-red-800">
                  ...
                  <p className="text-muted-foreground text-sm">77% of consumers make purchases based on brand name recognition.</p>
                </Card>
                ...
                <Card className="p-6 bg-orange-50 dark:bg-orange-950/20 border-orange-200 dark:border-orange-800">
                  ...
                  <p className="text-muted-foreground text-sm">Consistent branding can increase revenue by up to 23%.</p>
                </Card>
                ...
                <Card className="p-6 bg-yellow-50 dark:bg-yellow-950/20 border-yellow-200 dark:border-yellow-800">
                  ...
                  <p className="text-muted-foreground text-sm">Strong brands create 5x more customer loyalty than competitors.</p>
                </Card>
              </div>
            </div>
            
            <div>
              <h2 className="text-3xl font-bold text-space text-foreground mb-6">Our Brand Approach</h2>
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-sm">Craft compelling narratives that resonate with your target audience.</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <Check className="w-5 h-5 text-secondary mt-1" />
                  <div>
                    ...
                    <p className="text-muted-foreground text-sm">Maintain cohesive visual identity across all brand touchpoints.</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <Check className="w-5 h-5 text-secondary mt-1" />
                  <div>
                    ...
                    <p className="text-muted-foreground text-sm">Position your brand uniquely in the competitive landscape.</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <Check className="w-5 h-5 text-secondary mt-1" />
                  <div>
                    ...
                    <p className="text-muted-foreground text-sm">Build brand frameworks that grow with your business.</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="grid lg:grid-cols-2 gap-8 items-center">
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-6 mb-6">
                    ...
                    <div>
                      <div className="text-3xl font-bold text-space gradient-text mb-2">3 months</div>
