...
import { FileText, Users, CreditCard, Shield, AlertTriangle, Scale, ArrowRight, CheckCircle } from "lucide-react";
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            <motion.h2
              ...
              variants={fadeUpVariants}
            >
              Key <span className="bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent">Terms</span>
            </motion.h2>
            <motion.div
          ...
          >
            ...
            >
              ...
              >
                ...
                <motion.div variants={fadeUpVariants}>
                  <h2 className="text-3xl font-bold text-white mb-6 border-l-4 border-purple-500 pl-6">1. Agreement to Terms</h2>
                ...
                <motion.div variants={fadeUpVariants}>
                  <h2 className="text-3xl font-bold text-white mb-6 border-l-4 border-pink-500 pl-6">2. Our Services</h2>
                  <p className="text-gray-300 leading-relaxed">
                ...
                <motion.div variants={fadeUpVariants}>
                  <h2 className="text-3xl font-bold text-white mb-6 border-l-4 border-red-500 pl-6">3. User Responsibilities</h2>
                ...
                <motion.div variants={fadeUpVariants}>
                  <h2 className="text-3xl font-bold text-white mb-6 border-l-4 border-orange-500 pl-6">4. Intellectual Property</h2>
                ...
                <motion.div variants={fadeUpVariants}>
                  <h2 className="text-3xl font-bold text-white mb-6 border-l-4 border-yellow-500 pl-6">5. Fees and Payment</h2>
                  <p className="text-gray-300 leading-relaxed">
                ...
                <motion.div variants={fadeUpVariants}>
                  <h2 className="text-3xl font-bold text-white mb-6 border-l-4 border-green-500 pl-6">6. Confidentiality</h2>
                  <p className="text-gray-300 leading-relaxed">
                ...
                <motion.div variants={fadeUpVariants}>
                  <h2 className="text-3xl font-bold text-white mb-6 border-l-4 border-blue-500 pl-6">7. Termination</h2>
                ...
                <motion.div variants={fadeUpVariants}>
                  <h2 className="text-3xl font-bold text-white mb-6 border-l-4 border-indigo-500 pl-6">8. Disclaimers</h2>
                  <p className="text-gray-300 leading-relaxed">
                ...
                <motion.div variants={fadeUpVariants}>
                  <h2 className="text-3xl font-bold text-white mb-6 border-l-4 border-purple-500 pl-6">9. Limitation of Liability</h2>
                  <p className="text-gray-300 leading-relaxed mb-4">
                ...
                <motion.div variants={fadeUpVariants}>
                  <h2 className="text-3xl font-bold text-white mb-6 border-l-4 border-pink-500 pl-6">10. Governing Law</h2>
                  <p className="text-gray-300 leading-relaxed">
                ...
                <motion.div variants={fadeUpVariants}>
                  <h2 className="text-3xl font-bold text-white mb-6 border-l-4 border-red-500 pl-6">11. Changes to Terms</h2>
                  <p className="text-gray-300 leading-relaxed">
