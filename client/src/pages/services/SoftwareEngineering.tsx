  ...
  return (
    <Layout>
      <Helmet>
        ...
        <meta
          name="description"
          content="Custom software engineering solutions: web, mobile, cloud, and DevOps. Scalable, secure, and tailored for your business."
        />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            description:
              "Custom software engineering solutions: web, mobile, cloud, and DevOps. Scalable, secure, and tailored for your business.",
          })}
        </script>
      </Helmet>
      <motion.section
        ...
        className="py-16 px-4 md:px-16 bg-gradient-to-br from-purple-900 to-purple-700 rounded-3xl shadow-xl"
      >
        ...
        <p className="text-lg md:text-xl text-purple-100 mb-8 max-w-2xl">
          Custom software solutions for web, mobile, and cloud. We build scalable, secure, and
          high-performance applications tailored to your business goals.
        </p>
        <motion.div
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-3">
              {technologies.map((tech, i) => (
                <motion.span
                  key={tech}
                  className="bg-purple-800 text-purple-100 px-4 py-2 rounded-lg shadow"
        ...
        >
          <Link href="/contact">
            <span className="inline-block px-8 py-4 bg-gradient-to-r from-blue-500 to-purple-600 text-white font-bold rounded-xl shadow-lg hover:scale-105 transition-transform cursor-pointer">
              Get Started with Software Engineering
            </span>
          </Link>
        </motion.div>
      </motion.section>
